...
class TableQAgent(chainerrl.agent.Agent):
    ...
    def act_and_train(self, obs, reward):
        ...
        return self.select_action(obs, True)

    def act(self, obs):
        return self.select_action(obs, False)
    ...
    def select_action(self, obs, is_with_explore):
    ...
    def epsilon_greedy(self, obs_key):
        ...
        # exploitation (活用)
        max_q_action = self.greedy(obs_key)
        # どっちか選択
